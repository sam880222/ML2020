...
torch.save(feature_extractor.state_dict(), os.path.join(model_dir, 'extractor_model.bin'))
torch.save(label_predictor.state_dict(), os.path.join(model_dir, 'predictor_model.bin'))